...
zcmp_cur_reg	long	-1	' register last compared to 0 as part of instruction
zcmp_pending_reg long	-1
#endif
#ifdef OPTIMIZE_PTRA
...
#endif
#ifdef OPTIMIZE_CMP_ZERO
		mov	zcmp_cur_reg, zcmp_pending_reg
		neg	zcmp_pending_reg, #1
#endif		
